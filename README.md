...
![](https://github.com/Patcharanan/LAB-03/blob/master/1.PNG?raw=true)
* จากการผลการทดลองคือ เมื่อเราคลิกลงบนหน้าต่างของโปรแกรมที่รันอยู่ จะบอกถึงตำแหน่งเมาส์ที่เรากดลงไป ออกมาเป็นตำแหน่งคู่ลำดับ (x,y)
